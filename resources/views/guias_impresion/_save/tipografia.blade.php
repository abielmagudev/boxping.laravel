...
<div class="mb-3 row">
   <div class="col-sm">
      ...
      <select id="select-fuente" class="form-select {{ bootstrap_isInputInvalid('tipografia.fuente', $errors) }}" name="tipografia[fuente]">
   ...
   <div class="col-sm">
      ...
      <input type="number" min="0.0" step="0.1" id="input-fuente-tamano" class="form-control {{ bootstrap_isInputInvalid('tipografia.tamano', $errors) }}" name="tipografia[tamano]" value="{{ old('tipografia.tamano', $tipografia_tamano) }}">
   ...
   <div class="col-sm">
      ...
      <select id="select-fuente-medicion" class="form-select {{ bootstrap_isInputInvalid('tipografia.medicion', $errors) }}" name="tipografia[medicion]">
