...
<div class="mb-3">
   ...
   <input type="text" class="form-control {{ bootstrap_isInputInvalid('nombre', $errors) }}" id="input-descripcion" name="descripcion" value="{{ old('descripcion', $guia->descripcion) }}" placeholder="Opcional">
