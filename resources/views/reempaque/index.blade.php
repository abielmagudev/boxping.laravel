...
@component('@.bootstrap.card')
    ...
    @slot('body')
    <form action="{{ route('reempaque.update') }}" method="post" atuocomplete="off">
        @csrf
        @method('put')
        <div class="mb-3">
            <label for="input-numero" class="form-label small">Número de entrada</label>
            <input type="text" class="form-control" id="input-numero" name="numero" value="{{ old('numero') }}">
        </div>
        <div class="mb-3">
            <label class="form-label small" for="select-codigor">Código de reempacado</label>
            <select id="select-codigor" class="form-select" name="codigor">
        ...
        <div class="mb-3">
            ...
            <input type="password" class="form-control" id="input-clave" name="clave" value="">
        </div>
        <br>
